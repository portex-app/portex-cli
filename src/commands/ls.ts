...
export default class Ls extends BaseCommand {
    ...
    static override summary: string = 'get application list';
    ...
    public async run(): Promise<void> {
        ...
        const params: ApplicationQueryRequest = {
     ...
     */
    private async getApplicationList(params?: ApplicationQueryRequest): Promise<void> {
        try {
